...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item {{ Request::is('respos') ? 'active' : '' }}{{ Request::is('details') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-app" aria-expanded="{{ Request::is('services') ? 'true' : '' }}{{ Request::is('categories') ? 'true' : '' }}">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="multi-level collapse {{ Request::is('services') ? 'show' : '' }}{{ Request::is('categories') ? 'show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
