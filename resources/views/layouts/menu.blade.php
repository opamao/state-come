    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            @if (Auth::user()->type_user == 'directeur')
                ...
                <li
                    class="nav-item {{ Request::is('respos') ? 'active' : '' }}{{ Request::is('details') ? 'active' : '' }}">
                    <a href="{{ url('respos') }}" class="nav-link">
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            @endif
            {{-- <li class="nav-item {{ Request::is('objectifsrespo') ? 'active' : '' }}">
                <a href="{{ url('objectifsrespo') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
            ...
            <li
                class="nav-item {{ Request::is('clients') ? 'active' : '' }}">
                <a href="{{ url('clients') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Clients & prospects</span>
                </a>
            </li>
            <li
                class="nav-item {{ Request::is('taches') ? 'active' : '' }}">
                <a href="{{ url('taches') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
                    ...
                    <span class="sidebar-text">Tâches & rendez-vous</span>
                </a>
            </li>
            <li
                class="nav-item {{ Request::is('rapports') ? 'active' : '' }}">
                <a href="{{ url('rapports') }}" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
